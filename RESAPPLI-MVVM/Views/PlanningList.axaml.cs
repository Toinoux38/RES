...
public partial class PlanningList : Window
{
	public static readonly DirectProperty<PlanningList, AvaloniaList<AppointmentViewModel>> ItemsProperty = AvaloniaProperty.RegisterDirect<PlanningList, AvaloniaList<AppointmentViewModel>>(nameof(Items), o => o.Items, (o, v) => o.Items = v);
